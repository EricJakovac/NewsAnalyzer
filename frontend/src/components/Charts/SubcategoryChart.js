...
const SubcategoryChart = ({ topic }) => {
    ...
    return (
        <div className="subcategory-chart">
            ...
            <div className={`subcategory-chart__content-wrapper${showInfoBlock ? " gap-visible" : ""}`}>
                <div className={`subcategory-chart__table-container${showInfoBlock ? " table-shrink" : ""}`}>
                    <Table
                        data={articles}
                ...
                <div className={`subcategory-chart__info-block-animated${showInfoBlock ? " visible" : ""}`}>
